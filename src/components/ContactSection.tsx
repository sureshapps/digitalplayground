import { Mail, MessageCircle, Linkedin, Github, ArrowUpRight, Instagram, Facebook } from 'lucide-react';
...
const CONTACT_METHODS: ContactMethod[] = [
  ...
  },
  {
    ...
    href: 'https://wa.me/60104368680',
  },
  {
    icon: Instagram,
    label: 'Instagram',
    value: '@sureshksmy',
    href: 'https://www.instagram.com/sureshksmy/',
  },
  {
    icon: Facebook,
    label: 'Facebook',
    value: 'mesureshks',
    href: 'https://www.facebook.com/mesureshks',
  },
];
