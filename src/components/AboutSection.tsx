...
const ABOUT_TEXT =
  "With a passion for both design and development, I craft engaging digital experiences that balance aesthetics, usability, and performance. I transform ideas into modern web solutions that connect with users and deliver measurable results.";
